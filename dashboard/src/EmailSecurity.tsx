    ...
    return (
      <main className="email-onboarding">
        <section className="email-connect-card">
          ...
          <h1>Connect one inbox to Devin.</h1>
          ...
          <label className="consent-row">
            ...
            <span>I understand selected message content and agent-selected attachments are sent to Cognition/Devin.</span>
          </label>
          <button
  ...
  return (
    <main className="email-workspace">
      ...
      <aside className="email-detail flow-card" aria-label="Email analysis details">
        ...
        ) : <div className="email-empty">Select an analysis to inspect Devin’s evidence.</div>}
      </aside>
    </main>
  );
}
